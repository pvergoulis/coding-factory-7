...
public class Main {
    ...
    public static void main(String[] args) {
        List<Product> products1 = List.of(new Product("",12.5, 10), // H List.of epistrefei immutable list
                new Product("",12.5,10));

        List<Product> products2 = Arrays.asList(new Product("",12.5, 10), // H List.of epistrefei partially immutable list
                new Product("",12.5,10));
